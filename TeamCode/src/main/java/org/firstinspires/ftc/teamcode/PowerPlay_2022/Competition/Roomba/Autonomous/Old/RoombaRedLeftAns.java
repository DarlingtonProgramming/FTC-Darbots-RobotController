...
public class RoombaRedLeftAns extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        // Detection
        try {
            sleeveDetector = new RoombaTFDetectionBase(RoombaConstants.AllianceType.RED, hardwareMap, telemetry);
        ...
        for (int i = 0; i < 2; i++) {
            ...
            TrajectorySequence trajToStack = drive.trajectorySequenceBuilder(tempPose)
                    ...
                    .lineToSplineHeading(RoombaConstants.BLUE_LEFT_CONE.plus((i == 1 ? new Pose2d(1, -1) : new Pose2d())))
                    .build();
            ...
            TrajectorySequence trajToJunction = drive.trajectorySequenceBuilder(tempPose)
                    .lineToSplineHeading(RoombaConstants.BLUE_LEFT_MIDPOINT)
                    .lineToSplineHeading(RoombaConstants.BLUE_LEFT_HIGH_JUNC.plus((i == 1 ? new Pose2d(0, 0, toRadians(2)) : new Pose2d())))
                    .build();
        ...
        if (opModeIsActive()) {
            ...
            driveMethod.slideTo(SLIDE_INITIAL + RoombaConstants.SL_HIGH + 200, 0.45);
            drive.followTrajectorySequence(trajectories.get(0));

            drive.setPoseEstimate(driveMethod.stabilizeStrafeDrift(RoombaConstants.BLUE_LEFT_INITIAL_STRAFE, RoombaConstants.BLUE_LEFT_END_STRAFE)); //new Pose2d(34, 0, toRadians(180))
