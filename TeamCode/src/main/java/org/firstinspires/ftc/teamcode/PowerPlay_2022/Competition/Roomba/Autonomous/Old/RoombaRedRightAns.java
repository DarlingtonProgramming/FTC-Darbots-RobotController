    ...
    public void runOpMode() {
        ...
        for (int i = 0; i < 2; i++) {
            ...
            TrajectorySequence trajToStack = drive.trajectorySequenceBuilder(tempPose)
                    ...
                    .lineToSplineHeading(RoombaConstants.RED_RIGHT_CONE.plus(new Pose2d(0, (i == 1 ? 0 : -2))))
                    .build();
            ...
            TrajectorySequence trajToJunction = drive.trajectorySequenceBuilder(tempPose)
                    .lineToSplineHeading(RoombaConstants.RED_RIGHT_MIDPOINT)
                    .lineToSplineHeading(RoombaConstants.RED_RIGHT_HIGH_JUNC)
                    .build();
        ...
        if (opModeIsActive()) {
            ...
            driveMethod.slideTo(SLIDE_INITIAL + RoombaConstants.SL_HIGH + 300, 0.45);
            ...
            driveMethod.slideTo(SLIDE_INITIAL + RoombaConstants.SL_HIGH + 100, 0.95);
            sleep(1350);
            driveMethod.setPinched(false);
            sleep(500);
