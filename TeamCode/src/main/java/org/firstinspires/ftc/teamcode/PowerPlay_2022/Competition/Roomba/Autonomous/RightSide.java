...
@Autonomous(name = "bocchi the right \uD83E\uDD76\uD83E\uDD76\uD83E\uDD76", group = "1")
public class RightSide extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            slideTo(SLIDE_INITIAL + RoombaConstants.SL_LOW - 200);
            sleep(50);
            ...
            TrajectorySequence toStackFirstCone = drive.trajectorySequenceBuilder(mediumJunction.end())
                    ...
                    .addDisplacementMarker(5, () -> {
                        slideTo(SLIDE_INITIAL + RoombaConstants.CONE_HEIGHTS[0]);
                    })
                    .back(5)
                    .strafeLeft(12.5)
                    .forward(14)
            ...
            TrajectorySequence toHighJunctionFirstCone = drive.trajectorySequenceBuilder(toStackFirstCone.end())
                    .back(3.5)
                    .lineToSplineHeading(
                            new Pose2d(48,10, toRadians(270)),
