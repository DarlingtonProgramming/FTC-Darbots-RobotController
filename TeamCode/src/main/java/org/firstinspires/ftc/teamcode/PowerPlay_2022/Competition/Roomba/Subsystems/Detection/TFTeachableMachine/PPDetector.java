package org.firstinspires.ftc.teamcode.PowerPlay_2022.Competition.Roomba.Subsystems.Detection.TFTeachableMachine;
...
import org.firstinspires.ftc.teamcode.PowerPlay_2022.Competition.Roomba.Subsystems.Detection.TFTeachableMachine.classification.Classifier.Device;
import org.firstinspires.ftc.teamcode.PowerPlay_2022.Competition.Roomba.Subsystems.Detection.TFTeachableMachine.classification.Classifier.Model;
import org.firstinspires.ftc.teamcode.PowerPlay_2022.Competition.Roomba.Subsystems.Detection.TFTeachableMachine.utils.BorderedText;
import org.firstinspires.ftc.teamcode.PowerPlay_2022.Competition.Roomba.Subsystems.Detection.TFTeachableMachine.utils.ImageUtils;
import org.firstinspires.ftc.teamcode.PowerPlay_2022.Competition.Roomba.Subsystems.Detection.TFTeachableMachine.views.CameraConnectionFragment;
import org.firstinspires.ftc.teamcode.PowerPlay_2022.Competition.Roomba.Subsystems.Detection.TFTeachableMachine.views.LegacyCameraConnectionFragment;

import java.nio.ByteBuffer;
import java.util.List;

public class PPDetector implements ImageReader.OnImageAvailableListener, Camera.PreviewCallback {
    ...
    public PPDetector(Model modelType, String modelPath, Context ctx, Telemetry t) throws Exception{
    ...
    public PPDetector(Model modelType, String modelPath, String labelPath, Context ctx, Telemetry t) throws Exception{
                    ...
                    CameraConnectionFragment.newInstance(
                            new CameraConnectionFragment.ConnectionCallback() {
                                ...
                                public void onPreviewSizeChosen(final Size size, final int rotation) {
                                    ...
                                    PPDetector.this.onPreviewSizeChosen(size, rotation);
                                }
                            },
                            this,
                            getLayoutId(),
...
//        final int cropSize = Math.min(previewWidth, previewHeight);
    ...
    protected void onInferenceConfigurationChanged() {
        ...
        runInBackground(new Runnable() {
            @Override
            public void run() {
                PPDetector.this.recreateClassifier(model, device, numThreads);
            }
        });
    }
