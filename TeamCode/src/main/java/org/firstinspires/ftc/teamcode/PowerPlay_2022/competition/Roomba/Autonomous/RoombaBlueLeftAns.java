...
public class RoombaBlueLeftAns extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        // Detection
        try {
            sleeveDetector = new RoombaDetectionBase(Roomba_Constants.AllianceType.BLUE, hardwareMap, telemetry);
        ...
        if (opModeIsActive()) {
            ...
            driveMethod.slideTo(SLIDE_INITIAL + Roomba_Constants.SL_HIGH, 0.45);
            ...
            driveMethod.slideTo(SLIDE_INITIAL + Roomba_Constants.SL_HIGH - 100, 0.9);
            sleep(500);
            ...
            TrajectorySequence trajToStack = drive.trajectorySequenceBuilder(traj.end())
                    ...
                    .addTemporalMarker(1.8, () -> {
                        driveMethod.slideTo(SLIDE_INITIAL + Roomba_Constants.CONE_HEIGHTS[0], 0.7);
                    })
                    .lineToSplineHeading(Roomba_Constants.BLUE_LEFT_MIDPOINT)
                    .lineToSplineHeading(Roomba_Constants.BLUE_LEFT_CONE)
                    .build();
            ...
            TrajectorySequence trajToStack2 = drive.trajectorySequenceBuilder(trajToJunction.end())
                    .addTemporalMarker(1.5, () -> {
                        driveMethod.slideTo(SLIDE_INITIAL + Roomba_Constants.CONE_HEIGHTS[1], 0.5);
                    })
                    .lineToSplineHeading(Roomba_Constants.BLUE_LEFT_MIDPOINT)
                    .lineToSplineHeading(Roomba_Constants.BLUE_LEFT_CONE.plus((new Pose2d(1, -1))))
                    .build();
            ...
            if (visionResult.equals(Roomba_Constants.LABELS[0])) { // Eyes1
