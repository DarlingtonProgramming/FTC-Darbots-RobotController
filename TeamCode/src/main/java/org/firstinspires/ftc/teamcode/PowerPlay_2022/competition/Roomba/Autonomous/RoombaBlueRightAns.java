    ...
    public void runOpMode() {
        ...
        for (int i = 0; i < 2; i++) {
            ...
            TrajectorySequence trajToStack = drive.trajectorySequenceBuilder(tempPose)
                    ...
                    .lineToSplineHeading(Roomba_Constants.RED_RIGHT_CONE)
                    .build();
            ...
            TrajectorySequence trajToJunction = drive.trajectorySequenceBuilder(tempPose)
                    .lineToSplineHeading(Roomba_Constants.RED_RIGHT_MIDPOINT)
                    .lineToSplineHeading(Roomba_Constants.RED_RIGHT_HIGH_JUNC.plus(new Pose2d(0, (i == 1 ? -2 : 0))))
                    .build();
        ...
        if (opModeIsActive()) {
            ...
            driveMethod.slideTo(SLIDE_INITIAL + Roomba_Constants.SL_HIGH + 500, 0.45);
