...
public class Roomba_Constants {
    ...
    public static final Pose2d BLUE_LEFT_END_STRAFE = new Pose2d(37.5, -1, toRadians(180));
    public static final Pose2d BLUE_LEFT_MIDPOINT = new Pose2d(38, 10, toRadians(0));
    public static final Pose2d BLUE_LEFT_CONE = new Pose2d(65, 10, toRadians(0));
