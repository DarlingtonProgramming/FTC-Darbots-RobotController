...
public class TwoWheelTrackingLocalizer extends TwoTrackingWheelLocalizer {
    ...
    public static double PARALLEL_X = -5.4; // X is the up and down direction
    public static double PARALLEL_Y = 1.4; // Y is the strafe direction

    public static double PERPENDICULAR_X = -6;
    public static double PERPENDICULAR_Y = -1;

    public static double X_MULTIPLIER = 0.987890027603958; // Multiplier in the X direction
    public static double Y_MULTIPLIER = 0.972896382172162; // Multiplier in the Y direction
