...
public class MaxVelocityTuner extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        double effectiveKf = DriveConstants_Roomba.getMotorVelocityF(veloInchesToTicks(maxVelocity));
    ...
    private double veloInchesToTicks(double inchesPerSec) {
        return inchesPerSec / (2 * Math.PI * DriveConstants_Roomba.WHEEL_RADIUS) / DriveConstants_Roomba.GEAR_RATIO * DriveConstants_Roomba.TICKS_PER_REV;
    }
}
